                    ...
                    <div className="right">
                        ...
                        <div className="formInput">
                            ...
                            <div className="formInput">
                                ...
                                <input type="text" placeholder="ngawang" />
                            </div>
                            <div className="formInput">
                            ...
                            <div className="formInput">
                                <label>Email</label>
                                <input type="email" placeholder="ngawangyeshi1777@gmail.com" />
                            </div>
                            <div className="formInput">
                                <label>Phone</label>
                            ...
                            <div className="formInput">
                                <label>Address</label>
                                <input type="text" placeholder="Gyalposhing College Of Information Technology" />
                            </div>
                            <div className="formInput">
                                <label>Country</label>
